...
'el valor ya existe en la base de datos o está vacío': 'el valor ya existe en la base de datos o está vacío',
...
'purchase cost cannot be greater than sale price': 'costo de compra no puede ser mayor que precio de venta',
