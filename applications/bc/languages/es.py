...
'Close': 'Cerrar',
'Codigo no concuerda con la expresion: /^PRI\\sMI?\\s\\d{7}$/': 'Codigo no concuerda con la expresion: /^PRI\\sMI?\\s\\d{7}$/',
'Codigo no concuerda con la expresion: ^16329\\d{58}$': 'Codigo no concuerda con la expresion: ^16329\\d{58}$',
'Codigo no concuerda con la expresion: ^\\d{58}$': 'Codigo no concuerda con la expresion: ^\\d{58}$',
'Codigo no concuerda con la expresion: ^\\w{10}$': 'Codigo no concuerda con la expresion: ^\\w{10}$',
'Codigo no concuerda con la expresion: ^\\w{18}$': 'Codigo no concuerda con la expresion: ^\\w{18}$',
'Codigo no concuerda con la expresion: ^\\w{58}$': 'Codigo no concuerda con la expresion: ^\\w{58}$',
'Codigo no concuerda con la expresion: ^PRI\\sMI?\\s\\d{7}$': 'Codigo no concuerda con la expresion: ^PRI\\sMI?\\s\\d{7}$',
'Codigo no concuerda con la expresion: PRI\\sM\\s\\d{7}': 'Codigo no concuerda con la expresion: PRI\\sM\\s\\d{7}',
'Codigo no concuerda con la expresion: PRI\\sMI*\\s\\d{7}': 'Codigo no concuerda con la expresion: PRI\\sMI*\\s\\d{7}',
'Codigo no concuerda con la expresion: PRI\\sMI?\\s\\d{7}': 'Codigo no concuerda con la expresion: PRI\\sMI?\\s\\d{7}',
'Codigo no concuerda con la expresion: PRI\\sMI\\s\\d{7}': 'Codigo no concuerda con la expresion: PRI\\sMI\\s\\d{7}',
'Codigo ya escaneado...': 'Codigo ya escaneado...',
...
'Estado': 'Estado',
'Este codigo ya se habia escaneado con anterioridad...': 'Este codigo ya se habia escaneado con anterioridad...',
